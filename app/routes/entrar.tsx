...
export default function AuthChoice() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-[#FBFBFA] font-sans text-[#2D263B] selection:bg-[#EAE4F2] selection:text-[#2D263B]">
      ...
      {/* Meio da página com o Card de opções */}
        ...
        >
          ...
          <div className="relative flex flex-col gap-4 text-center">
            ...
            <p className="text-sm text-[#6B6378]">
              Escolha uma das opções abaixo para prosseguir com sua conta.
            </p>

            <div className="mt-4 flex flex-col gap-3">
              <Link
                to="/login"
                className="group relative inline-flex items-center justify-center rounded-full bg-[#2D263B] px-6 py-3.5 text-sm font-medium text-[#FBFBFA] shadow-sm transition-all duration-300 hover:bg-[#433A54] hover:shadow-md"
              >
                Entrar como cliente
                <span
                  aria-hidden="true"
